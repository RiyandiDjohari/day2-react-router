    ...
    <Layout>
      <div className="container mx-auto p-4">
        <div className="flex flex-col items-center lg:flex-row gap-8 my-10">
          ...
          <div className="basis-[50%]">
            ...
            <div id="misi">
              ...
              <ul className="list-disc list-inside">
                {
                  [1,2,3,4].map((item) => (
                    <li key={item} className="mb-2">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloremque, expedita!</li>
                  ))
                }
          ...
          {/* Right Side */}
          <div className="basis-[50%] w-full h-full flex items-center justify-center"><img src="/vite.svg" alt="image" className="w-[300px] h-[250px]" /></div>
        </div>
      </div>
    </Layout>
  );
